...
public class Main {
    public static void main(String[] args) {
        ...
        TransferLog withdrawLog1 = account1.withdraw(300.0); // Retirar 300 de la cuenta 1

        account2.deposit(100.0); // Depositar 100 en la cuenta 2
        TransferLog withdrawLog2 = account2.withdraw(700.0); // Intentar retirar 700 de la cuenta 2 (debería fallar)

        // Imprimir detalles de las cuentas
        printAccountBalance(account1, account2);

        // Verificar si las operaciones fueron exitosas
        // TODO: Puedo crear un helper para imprimir la información de la transacción, no solo si está fallida o no.
