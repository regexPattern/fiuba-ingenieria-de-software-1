...
public class OwnershipSteps {
  ...
  @And(
      "A registered client with DNI {long}, name {string} and surname {string} who is the owner of the account")
  ...
  @And(
      "A registered client with DNI {long}, name {string} and surname {string} who married the account owner on {string}")
  public void createClientWhoIsPartnerOfOwner(
      Long dni, String name, String surName, String marriageDateString) {
